...
export function LinkPreviewParagraph() {
  return (
    <div className="flex h-[40rem] flex-col items-center justify-center px-4">
      <div className="mx-auto mb-10 max-w-3xl text-xl text-neutral-500 md:text-3xl dark:text-neutral-400">
      ...
      <div className="mx-auto max-w-3xl text-xl text-neutral-500 md:text-3xl dark:text-neutral-400">
        Visit{" "}
        <LinkPreview
