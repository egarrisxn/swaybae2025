                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-full border px-6 py-3 shadow focus:border-primary focus:outline-none dark:bg-black dark:shadow-none dark:focus:border-primary"
                      />
