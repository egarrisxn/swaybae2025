      ...
      <div className="container mx-auto my-12 max-w-2xl px-4 lg:max-w-7xl xl:px-0">
        <div className="mx-auto grid grid-cols-1 items-center leading-relaxed">
          <PageHeader
            ...
            linkText="Home"
          />
          <h2 className="bg-gradient-to-t from-neutral-600 via-neutral-700 to-neutral-800 bg-clip-text pb-3 pt-12 text-4xl font-bold tracking-tight text-transparent drop-shadow-[0_0.5px_0.5px_rgba(0,0,0,0.8)] lg:text-5xl xl:text-6xl dark:from-stone-200 dark:to-neutral-200">
            Welcome to my blog!
          </h2>
